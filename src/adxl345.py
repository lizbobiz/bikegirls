...
ACTIVITY = 0x10         # [D4] = 1'b1 in INT_ENABLE

FIFO_MODE = 0x80        # [D7:D6] = 2'b10 in FIFO_CTL
TRIGGER = 0x00          # [D5] = 1'b0 in FIFO_CTL
SAMPLES = 0x00          # [D4:D0] = 5'b00001 in FIFO_CTL

THRESHOLD = 0x20        # [D7:D0] = 8'd8 in THRESH_ACT
ACT_CONFIG = 0x70       # [D7:D4] = 4'b0111 in ACT_INACT_CTL
...
class ADXL345:
    ...
    def config_act(self):
        ...
        bus.write_byte_data(self.addr, THRESH_ACT, THRESHOLD)
